...
<body>
    ...
    $stmt = $con->prepare("SELECT * FROM add_recipe");
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo ("<td>" . "<a id='deletelink' href='./recipedelete.php?id=" . urlencode($row['Recipe_ID']) . "'>Delete</a>" . " | " .
                  "<a id='editlink' href='./editrecipe.php?id=" . urlencode($row['Recipe_ID']) . "'>Update</a>" . "</td>");
            echo ("</tr>");
        }
    }
